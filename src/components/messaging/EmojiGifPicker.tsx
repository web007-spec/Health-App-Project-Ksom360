...
import { Smile, Search, Loader2, Film } from "lucide-react";
...
function EmojiPicker({ onSelectEmoji }: { onSelectEmoji: (emoji: string) => void }) {
...
function GifPicker({ onSelectGif }: { onSelectGif: (gifUrl: string) => void }) {
  const [open, setOpen] = useState(false);
