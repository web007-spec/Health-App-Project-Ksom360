...
export default function ClientQuickPlans() {
  ...
  // Filter plans: hide invisible ones
          ...
          {selectedPlan && (
            <ScrollArea className="max-h-[80vh]">
              <div className="p-6 space-y-5">
                ...
                {/* Coach Guidance */}
                {selectedPlan.description?.coach_guidance && selectedPlan.description.coach_guidance.length > 0 && (
                  <>
                    <Separator />
                    <div className="space-y-2">
                      <h3 className="text-sm font-semibold flex items-center gap-1.5">
                      ...
                      <ul className="space-y-1.5">
                        {selectedPlan.description.coach_guidance.map((tip, i) => (
                          <li key={i} className="flex items-start gap-2 text-sm text-muted-foreground">
                            <span className="mt-1 h-1.5 w-1.5 rounded-full bg-blue-400 shrink-0" />
                            {tip}
                          </li>
