...
export default function ClientProtocolDetail() {
  ...
  const weeklyProgression = generateWeeklyProgression(protocol.duration_days, protocol.fast_target_hours);
  const schedule = getDailySchedule(protocol.fast_target_hours);
      ...
      <div className="pb-24 w-full">
        ...
        <div className="grid grid-cols-3 gap-3 px-5 mt-6">
          <div className="rounded-xl bg-muted/50 p-3 text-center space-y-1">
            ...
            <p className="text-xl font-bold">{protocol.fast_target_hours}h</p>
          ...
          <Section title="Daily Schedule Example" icon={<Clock className="h-5 w-5 text-blue-400" />}>
            <div className="space-y-2 text-sm">
              <div className="flex justify-between rounded-lg bg-muted/40 px-4 py-3">
                ...
                <span className="font-semibold">{schedule.stopEating}</span>
              </div>
              <div className="flex justify-between rounded-lg bg-muted/40 px-4 py-3">
                <span className="text-muted-foreground">Break fast</span>
                <span className="font-semibold">{schedule.breakFast}</span>
              </div>
            </div>
            <div className="mt-3 text-sm text-muted-foreground space-y-1">
              <p>Meals typically include:</p>
              <ul className="list-disc list-inside pl-1 space-y-0.5">
                <li>Lunch</li>
                <li>Dinner</li>
                <li>Optional protein snack</li>
              </ul>
              <p className="mt-2 text-xs italic">Adjust timing to fit your routine.</p>
            </div>
          </Section>
